...
echo "Result: <span style=color:red;>" . $marks . "</span><br>";
if ($marks==30) {

    echo "<h2>Excelent Good job!</h2><br>";
    # code...
}else { " Thanks!";}
...
<form action="" method="get">
    ...
    <fieldset>
        ...
        <p>
            ...
            <input type="radio" name="q1" value="1" > JavaScript<br>
            <input type="radio" name="q1" value="0"> JavaSight<br>
        </p>
        <p>
            What is HTML stands for?<br>
            <input type="radio" name="q2" value="0" > HyperText Transport Protocol<br>
            <input type="radio" name="q2" value="1"> Hyper Text Transfer Protocol<br>
        </p>

        <p>
            What is CSS stands for?<br>
            <input type="radio" name="q3" value="1" > Cascaded Style sheet<br>
